...
module.exports = async (member, messageId) => {
  ...
  if (giveaway.pauseOptions.isPaused) return "> <a:r2_rice:868583626227478591> 這個抽獎已暫停。";

  try {
    await giveaway.pause();
    return "> <a:r3_rice:868583679465758820> 主辦者暫停了這個抽獎。";
  } catch (error) {
    member.client.logger.error("Giveaway Pause", error);
    return `> <a:r2_rice:868583626227478591> 花瓶在暫停抽獎時碎掉了：${error.message}`;
  }
};
