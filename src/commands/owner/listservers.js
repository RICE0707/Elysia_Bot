  ...
  async messageRun(message, args) {
    ...
    const buildEmbed = () => {
      ...
      const embed = new EmbedBuilder()
        ...
        .setAuthor({ name: "花瓶所在的群組", iconURL: 'https://cdn.discordapp.com/attachments/1067805752183488663/1068501885193039973/1015210055_61696d776b439.jpg', url: 'https://github.com/RICE0707/Elysia_Bot' })
        .setFooter({ text: `來自花瓶星球的科技支援 v3.0 - ${match ? "本頁的" : "全部的"}群組：${total} 個 • 頁數 ${currentPage} / ${totalPages}`, iconURL: 'https://cdn.discordapp.com/attachments/1067805752183488663/1068501885193039973/1015210055_61696d776b439.jpg' });
