...
async function getInviteCodes({ guild }, user) {
  ...
  const embed = new EmbedBuilder()
    .setAuthor({ name: `${user.username} 的邀請連結`, iconURL: 'https://cdn.discordapp.com/attachments/1067805752183488663/1068501885193039973/1015210055_61696d776b439.jpg', url: 'https://discord.gg/c4tKJME4hE'  })
