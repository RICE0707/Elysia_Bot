...
async function getTranslation(author, input, outputCode) {
  ...
  const embed = new EmbedBuilder()
    ...
    .setTimestamp()
    .setFooter({ text: `來自花瓶星球的科技支援 v3.0 - 取自於 Google - ${data.inputLang} (${data.inputCode}) 翻譯為 ${data.outputLang} (${data.outputCode})`, iconURL: 'https://cdn.discordapp.com/attachments/1067805752183488663/1068501885193039973/1015210055_61696d776b439.jpg' });
