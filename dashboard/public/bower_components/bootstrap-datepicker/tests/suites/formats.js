...
test('YYYY-MM-DD: Regression: Prevent potential month overflow in small-to-large formats (Mar 31, 2012 -> Mar 01, 2012)', function(){
    this.input
        .val('31-03-2012')
        .datepicker({format: 'YYYY-MM-DD'})
        .datepicker('setValue');
...
test('YYYY-MM-DD: Leap day', function(){
    this.input
        .val('29-02-2012')
        .datepicker({format: 'YYYY-MM-DD'})
        .datepicker('setValue');
